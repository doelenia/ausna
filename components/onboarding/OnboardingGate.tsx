...
function OnboardingOpenCallsStep({ onComplete }: { onComplete: () => void }) {
  ...
  const [autoGeneratedAttempted, setAutoGeneratedAttempted] = useState(false)
  ...
  useEffect(() => {
    if (autoGeneratedAttempted) return
    setAutoGeneratedAttempted(true)
    void handleGenerateDraft()
  }, [autoGeneratedAttempted])
