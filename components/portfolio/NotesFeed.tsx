...
import { BookMarked, Edit, Trash2, Pencil } from 'lucide-react'
...
export function NotesFeed({
  ...
  useEffect(() => {
    ...
    fetchInitialNotes()
    return () => ac.abort()
  }, [portfolioId, selectedCollectionId])
  ...
  }, [portfolioId, loadingMore, hasMore, selectedCollectionId])
    ...
    <div className="space-y-6">
      ...
      {filteredNotes.length > 0 || showCollectionTabs ? (
        <div className="space-y-4 mb-8">
          ...
          {/* Load more trigger — show when there are more pages */}
      ...
      ) : notes.length === 0 && !showCollectionTabs ? (
